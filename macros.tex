...
\newtheorem{korollar}[maincounter]{Korollar}
\newtheorem{bemerkung}[maincounter]{Bemerkung}
\newtheorem{theorem}[maincounter]{Satz}
\newtheorem{satz}[maincounter]{Satz}
\newtheorem{konvention}[maincounter]{Konvention}
\newtheorem{aufgabe}[excounter]{Übungsaufgabe}
\newtheorem{beispiel}[maincounter]{Beispiel}
\newtheorem{beispiele}[maincounter]{Beispiele}
\newtheorem{gegenbespiel}[maincounter]{Gegenbeispiel}
\newtheorem{vermutung}[maincounter]{Vermutung}
...
\newtheorem{frage}[maincounter]{Frage}
...
\newcommand{\qoq}{\quad\text{oder}\quad}